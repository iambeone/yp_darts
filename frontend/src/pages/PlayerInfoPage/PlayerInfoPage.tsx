      ...
      <DetailedInfo>
        <Wrapper>
          <DetailedInfoItemSpan>
            ...
            <InfoText>
              {dateFormatter(true, player?.dateOfBirth?.toString())}
            </InfoText>
          </DetailedInfoItemSpan>
          <DetailedInfoItemSpan>
        ...
        <DetailedInfoItemSpan>
          ...
          />
          <InfoText>
            {player.educationalInstitution ? player.educationalInstitution : ""}{" "}
            {player.speciality ? `(${player.speciality})` : ""}
            {player.endOfEducation !== null
              ? `, ${dateFormatter(false, player?.endOfEducation?.toString())}`
              : ""}
          </InfoText>
        </DetailedInfoItemSpan>
        <DetailedInfoItemSpan>
